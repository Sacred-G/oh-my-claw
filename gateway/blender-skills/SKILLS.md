...
**Command:** `~/oh-my-claw/blender-skills/blender_wrapper.sh get_scene_info`
...
**Command:** `~/oh-my-claw/blender-skills/blender_wrapper.sh list_objects`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh create_object '{"obj_type": "CUBE", "name": "MyCube", "location": [2, 0, 0]}'`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh select_object '{"name": "Cube"}'`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh transform_object '{"name": "Cube", "location": [5, 0, 0], "scale": [2, 2, 2]}'`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh delete_object '{"name": "Cube"}'`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh render_scene '{"output_path": "/tmp/render.png"}'`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh set_camera_view '{"location": [7, -7, 5], "rotation": [1.1, 0, 0.8]}'`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh add_material '{"obj_name": "Cube", "material_name": "Red", "color": [1.0, 0.0, 0.0]}'`
...
**Example:** `~/oh-my-claw/blender-skills/blender_wrapper.sh execute_command '{"command": "bpy.context.scene.render.engine"}'`
...
```bash
# Create a cube
~/oh-my-claw/blender-skills/blender_wrapper.sh create_object '{"obj_type": "CUBE", "name": "MyCube", "location": [0, 0, 0]}'

# Create a light
~/oh-my-claw/blender-skills/blender_wrapper.sh create_object '{"obj_type": "LIGHT", "name": "Light", "location": [5, 5, 5]}'

# Create a camera
~/oh-my-claw/blender-skills/blender_wrapper.sh create_object '{"obj_type": "CAMERA", "name": "Camera", "location": [7, -7, 5]}'

# Set camera view
~/oh-my-claw/blender-skills/blender_wrapper.sh set_camera_view '{"location": [7, -7, 5], "rotation": [1.1, 0, 0.8]}'

# Add color to cube
~/oh-my-claw/blender-skills/blender_wrapper.sh add_material '{"obj_name": "MyCube", "material_name": "Blue", "color": [0.0, 0.5, 1.0]}'

# Render
~/oh-my-claw/blender-skills/blender_wrapper.sh render_scene '{"output_path": "/tmp/my_render.png"}'
```

### Animate an object
```bash
# Move object to different positions and render frames
~/oh-my-claw/blender-skills/blender_wrapper.sh transform_object '{"name": "Cube", "location": [0, 0, 0]}'
# (render frame)
~/oh-my-claw/blender-skills/blender_wrapper.sh transform_object '{"name": "Cube", "location": [2, 0, 0]}'
# (render frame)
~/oh-my-claw/blender-skills/blender_wrapper.sh transform_object '{"name": "Cube", "location": [4, 0, 0]}'
# (render frame)
```
